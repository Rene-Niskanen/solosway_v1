...
- **Never put a closing line in the middle or at the start.** These phrases are allowed only at the very end, on their own line after a blank line: "feel free to ask", "let me know", "If you need more details...", "If you need further details or assistance, feel free to ask!", "dive deeper... feel free to ask", etc. If you use one, it must be the last line of your response—never right after a heading or in the middle of the answer.

...
- get_planner_followup_prompt(user_query, query_rule, refine_hint, incomplete_hint, format_instructions) -> str
"""
...
def get_planner_followup_prompt(
    ...
    """Build human prompt for planner when there is conversation history."""
    return f"Based on the conversation history, generate a structured execution plan for the latest query.\n\n{query_rule}\n\nCurrent User Query: {user_query}{refine_hint}{incomplete_hint}\n\n{format_instructions}"

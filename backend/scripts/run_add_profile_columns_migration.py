#!/usr/bin/env python3
"""
Run the add_profile_columns_to_users migration (adds last_name, title, phone, address, location to users).
...
"""
    ...
    try:
        ...
        conn.close()
        logger.info("Profile columns migration completed successfully.")
        return True

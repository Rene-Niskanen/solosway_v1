  ...
  const renderNavItem = (item: NavItem) => {
    ...
    return (
      <button
        ...
        className={`w-full flex items-center gap-3 px-3 py-1.5 rounded-lg transition-all duration-150 group relative ${
          active 
          ...
          <div className="flex flex-col h-full pt-4 pb-3">
            ...
            <div className="px-3">
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-1.5 rounded-lg transition-all duration-150 ${

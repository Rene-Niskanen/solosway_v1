  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`flex items-center justify-center transition-all duration-200 text-slate-600 hover:text-green-500 focus:outline-none outline-none ${sizeClasses[size]} ${className}`}
        whileHover={{ 
          scale: 1.08,
          x: 1
        }}

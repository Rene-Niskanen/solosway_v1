  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex justify-center items-start py-12 px-4">
        <div className="w-full max-w-4xl bg-background p-8 rounded-lg shadow-md">
          {/* Header Section */}
          <div className="flex flex-col items-center text-center mb-8">
            <div className="w-16 h-16 mb-4">
              <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-blue-600">
            ...
            <h1 className="text-3xl font-bold text-foreground">Book a Live Demo</h1>
            <p className="text-muted-foreground max-w-2xl mt-4">
              Schedule a personalized demo with one of our product specialists to see how our AI-powered valuation tools can save you time, improve accuracy, and help you close more deals.
            </p>
          </div>
          ...
          <div className="w-full">
            ...
            >
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-lg font-medium">Calendar Integration</p>
                <p className="text-muted-foreground text-sm mt-2">
                  To embed your calendar widget, replace this placeholder with your calendar service's embed code.
                </p>
          ...
          <div className="mt-8 bg-blue-50 p-6 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-900 mb-3">Alternative Contact Methods</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
              <div>
                <strong>Email:</strong> demo@solosway.com
              </div>
              <div>
            ...
            <p className="text-blue-700 text-sm mt-3">
              Can't find a suitable time? Contact us directly and we'll arrange a custom demo session.
            </p>
          </div>
        </div>
      </div>
